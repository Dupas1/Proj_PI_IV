...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		FlashCard flashcard1 = new FlashCard(null,"Qual é o seu nome ?",null,"Pessoal",null,sdf.parse("21/11/2023"),1,maria);
		FlashCard flashcard2 = new FlashCard(null,"Qual é o nome da sua mãe ?",null,"Pessoal",null,sdf.parse("20/11/2023"),1,alex);
